...
if __name__ == '__main__':
   ...
   # Создание пустых рамок для отступов
    ...
    input_button = tk.Button(root, text="Зашифровать текст", command=encode_vijn, width=16, height=2)
    input_button.pack(pady=5)
    input_button.config(font=("Arial", 10))
    
    output_button = tk.Button(root, text="Расшифровать текст", command=decode_vijn, width=16, height=2)
