...
/* Консультация */
     do_consulting:-
           game_is(X),!,
           concat("Рекомендуемая игра: ",X,Temp),
           concat(Temp,".",Result),
...
/* Продукционные правила */
     game_is("The Witcher"):-
           it_is("однопользовательской"),
           positive("имеет", "цену до 500 руб."),
           positive("имеет","конечную цель"),
           positive("имеет","вид от третьего лица"),
           positive("имеет","боевую систему"),
           positive("имеет", "открытый мир"),!.
     game_is("Dying Light"):-
           it_is("однопользовательской"),
           positive("имеет", "цену до 1000 руб"),
           positive("имеет","конечную цель"),
           positive("имеет","вид от первого лица"),
           positive("имеет","боевую систему"),
           positive("имеет","открытый мир"),!.
     game_is("Warcraft 3"):-
           it_is("однопользовательской"),
           positive("имеет","цену до 500 руб"),
           positive("имеет","вид сверху"),
           positive("имеет","экономическую систему"),
           positive("имеет","боевую систему"),!.
     game_is("XCOM: Enemy Unknown"):-
           it_is("однопользовательской"),
           positive("имеет","цену до 500 руб"),
           positive("имеет","конечную цель"),
           positive("имеет","пошаговое течением времени"),
           positive("имеет", "вид сверху"),
           positive("имеет","боевую систему"),!.
     game_is("Half-Life: Alyx"):-
           it_is("однопользовательской"),
           positive("имеет","цену до 1000 руб"),
           positive("имеет","конечную цель"),
           positive("имеет","вид от первого лица"),
           positive("имеет","боевую систему"),
           positive("имеет", "реалистичную физику"),!.
     game_is("Battle Brothers"):-
           it_is("однопользовательской"),
           positive("имеет","цену до 500 руб"),
           positive("имеет","вид сверху"),
           positive("имеет","пошаговое течением времени"),
           ...
           positive("имеет", "экономическую систему"),!.
     game_is("Left 4 Dead"):-
           it_is("многопользовательской"),
           positive("имеет", "цену до 500 руб"),
           positive("имеет","вид от первого лица"),
           positive("имеет","боевую систему"),
           positive("имеет","кооператив"),!.
     game_is("Rust"):-
           it_is("многопользовательской"),
           positive("имеет", "цену до 1000 руб"),
           positive("имеет","вид от первого лица"),
     ...
     game_is("Divinity: Original Sin"):-
           ...
           positive("имеет","экономическую систему"),!.
     it_is("однопользовательской"):-
           positive("Игра является", "однопользовательской"),!.
     it_is("многопользовательской"):-
           positive("Игра является","многопользовательской"),!. 
