...
class MainWindow(QWidget):
    def __init__(self):
        ...
        g_label, self.g_input = self.create_input('Введите переменную G:')
        layout_g_input = QHBoxLayout()
        layout_g_input.addWidget(g_label)
        layout_g_input.addWidget(self.g_input)
        ...
        layout.addLayout(layout_g_input)
