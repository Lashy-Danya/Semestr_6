...
class MainWindow(QWidget):
    def __init__(self):
        ...
        lambda_label, self.lambda_input = self.create_input('Введите переменную Lambda:')
        layout_lambda_input = QHBoxLayout()
        layout_lambda_input.addWidget(lambda_label)
        layout_lambda_input.addWidget(self.lambda_input)
        ...
        layout.addLayout(layout_lambda_input)
    ...
    def generate_array(self):
        ...
        new_array_np = np.log(1 - array_np) / -lambd
